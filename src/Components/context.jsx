  ...
  const MedicareSupplementAdvantage = () => {
    return dispatch({
      ...
      payload: {
        ...
        para1: `We run a Medicare supplement and advantage campaign. Custom calling campaigns can be created for live transfer leads, and sales scripts can also be used to effectively sell Medicare insurance and set appointments with potential customers Live transfer sales leads for Medicare supplements are purchased from call center providers and top vendors for Medicare supplements and advantage leads include those that offer call center telesales and custom marketing campaigns.`,
