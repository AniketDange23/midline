      ...
      <div className='bg-white px-4 py-5 box-shadow mb-5'>
        ...
        <ul className='list-unstyled'>
          {services.map((service, index) => (
            <li
              key={index}
              className='border-bottom border-color d-flex align-items-center project-link'
            >
              <FaRegCheckCircle className='mr-3' />
              <NavLink
                to={service.Link}
                className='text-color d-block pb-3 mt-3 text-decoration-none  '
              >
              {service.name}
              </NavLink>
            </li>
      ...
      <div className='bg-white px-4 py-5 box-shadow mb-5'>
        ...
        <form action='#'>
          <input
            ...
            name='name'
            id='name'
            className='form-control form-control-sm border-0 rounded-0 box-shadow mb-3'
            placeholder='Name'
          />
          <input
            type='email'
          ...
          <textarea
            name='message'
            id='message'
            className='form-control form-control-sm border-0 rounded-0 box-shadow mb-3 py-3 px-4'
