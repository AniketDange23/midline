...
const factsData = [ 
  ...
  { icon: FiTarget, count:70, text: 'Expert Worker' },  { icon: HiOutlineEmojiHappy, count: 9, text: 'Happy Clients', },
    ...
    <div className="container-fluid bg-dark  mb-5  ">
      <div className="row  py-5  d-flex align-content-center  ">
        {factsData.map((fact, index) => (
          <div key={index} className="col-lg-3 align-content-center  col-sm-6 mb-3 mb-lg-0">
            <div className="d-flex align-items-center">
              {<fact.icon className="icon-lg  mr-3 " />}
              <div>
                <h3 >
                  <span className="count  text-white" data-count={fact.count}>0 </span>
                </h3>
